...
class RequirementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create requirement" do
    assert_difference('Requirement.count') do
      post requirements_url, params: { requirement: { description: @requirement.description, hours_required: @requirement.hours_required } }, as: :json
    end
  ...
  test "should update requirement" do
    patch requirement_url(@requirement), params: { requirement: { description: @requirement.description, hours_required: @requirement.hours_required } }, as: :json
    assert_response 200
  end
