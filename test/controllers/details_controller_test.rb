...
class DetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post details_url, params: { detail: { cme_id: @detail.cme_id, description: @detail.description } }, as: :json
    end
  ...
  test "should update detail" do
    patch detail_url(@detail), params: { detail: { cme_id: @detail.cme_id, description: @detail.description } }, as: :json
    assert_response 200
  end
