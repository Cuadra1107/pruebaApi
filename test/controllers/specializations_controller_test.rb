...
class SpecializationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create specialization" do
    assert_difference('Specialization.count') do
      post specializations_url, params: { specialization: { description: @specialization.description, name: @specialization.name } }, as: :json
    end
  ...
  test "should update specialization" do
    patch specialization_url(@specialization), params: { specialization: { description: @specialization.description, name: @specialization.name } }, as: :json
    assert_response 200
  end
