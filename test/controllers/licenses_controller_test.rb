...
class LicensesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create license" do
    assert_difference('License.count') do
      post licenses_url, params: { license: { description: @license.description, source: @license.source } }, as: :json
    end
  ...
  test "should update license" do
    patch license_url(@license), params: { license: { description: @license.description, source: @license.source } }, as: :json
    assert_response 200
  end
